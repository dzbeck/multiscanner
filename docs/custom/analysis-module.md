...
Modules are intended to be quickly written and incorporated into the MultiScanner framework. A module must be located in the `modules <https://github.com/awest1339/multiscanner/tree/master/modules>`_ folder before it can be used. The configuration file does not need to be manually updated.
